...
export class SessionResponseDto {
  ...
  static fromEntity(session: Session): SessionResponseDto {
    return {
      ...
      autoRestartIntervalHours: session.autoRestartIntervalHours,
      autoRestartLastRun: session.autoRestartLastRun,
      callRejector: session.callRejector,
      callRejectorAutoReply: session.callRejectorAutoReply,
    };
  }
}
